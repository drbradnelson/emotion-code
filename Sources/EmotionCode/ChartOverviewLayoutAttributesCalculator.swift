...
private extension ChartOverviewLayoutAttributesCalculator {
    ...
    func calculateFrameForRowElement(forRowPosition position: ChartRowPosition, inArea area: CGRect) -> CGRect {
    ...
    func calculateHorizontalOffsetForRow(atPosition position: ChartRowPosition) -> CGFloat {
        let offset = calculateColumnOffset(forColumnIndex: position.columnIndex)
        return offset
    }

    func calculateVerticalOffsetForRow(atPosition position: ChartRowPosition) -> CGFloat {
